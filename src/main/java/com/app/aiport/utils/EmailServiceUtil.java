...
/**
 * Сервис утилита, которая отправляет email'ы.
 */
@Slf4j
@Service
@AllArgsConstructor
public class EmailServiceUtil {
    ...
    public void sendEmail(EmailContainer emailContainer) throws MessagingException {
        ...
        log.debug("Sending email " + emailContainer.getSubject() + ", to user: " + emailContainer.getFullName());
